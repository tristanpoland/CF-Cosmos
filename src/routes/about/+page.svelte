            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8"
                ...
                {:else}
                    <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
                        <!-- Stars -->
                        <div class="relative overflow-hidden rounded-2xl bg-neutral-900 p-6 lg:col-span-1 xl:col-span-1">
                            <div class="absolute inset-0 bg-gradient-to-bl from-blue-950/30 via-transparent to-transparent"></div>
                            <div class="relative flex items-center">
                                <Star class="h-6 w-6 text-yellow-400 mr-3" />
                                <div>
                                    <p class="text-2xl font-semibold text-white">
                                        {githubStats.stars?.toLocaleString() ?? 0}
                                    </p>
                        ...
                        <div class="relative overflow-hidden rounded-2xl bg-neutral-900 p-6 lg:col-span-1 xl:col-span-1">
                            <div class="absolute inset-0 bg-gradient-to-bl from-blue-950/30 via-transparent to-transparent"></div>
                            <div class="relative flex items-center">
                                <GitFork class="h-6 w-6 text-blue-400 mr-3" />
                                <div>
                                    <p class="text-2xl font-semibold text-white">
                                        {githubStats.forks?.toLocaleString() ?? 0}
                                    </p>
                        ...
                        <div class="relative overflow-hidden rounded-2xl bg-neutral-900 p-6 lg:col-span-1 xl:col-span-1">
                            <div class="absolute inset-0 bg-gradient-to-bl from-blue-950/30 via-transparent to-transparent"></div>
                            <div class="relative flex items-center">
                                <Users class="h-6 w-6 text-green-400 mr-3" />
                                <div>
                                    <p class="text-2xl font-semibold text-white">
                                        {githubStats.contributors?.toLocaleString() ?? 0}
                                    </p>
                        ...
                        <div class="relative overflow-hidden rounded-2xl bg-neutral-900 p-6 lg:col-span-1 xl:col-span-1">
                            <div class="absolute inset-0 bg-gradient-to-bl from-blue-950/30 via-transparent to-transparent"></div>
                            <div class="relative flex items-center">
                                <GitCommit class="h-6 w-6 text-orange-400 mr-3" />
                                <div>
                                    <p class="text-2xl font-semibold text-white">
                                        {githubStats.totalCommits?.toLocaleString() ?? 0}
                                    </p>
                                    <p class="text-sm text-gray-400">Total Commits</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative overflow-hidden rounded-2xl bg-neutral-900 p-6 lg:col-span-1 xl:col-span-1">
                            <div class="absolute inset-0 bg-gradient-to-bl from-blue-950/30 via-transparent to-transparent"></div>
                            <div class="relative flex items-center">
                                <GitBranch class="h-6 w-6 text-indigo-400 mr-3" />
                                <div>
                                    <p class="text-2xl font-semibold text-white">
                                        {githubStats.recentCommits?.toLocaleString() ?? 0}
                                    </p>
                                    <p class="text-sm text-gray-400">Recent Commits</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative overflow-hidden rounded-2xl bg-neutral-900 p-6 lg:col-span-1 xl:col-span-1">
                            <div class="absolute inset-0 bg-gradient-to-bl from-blue-950/30 via-transparent to-transparent"></div>
                            <div class="relative flex items-center">
                                <Clock class="h-6 w-6 text-purple-400 mr-3" />
                                <div>
                                    <p class="text-2xl font-semibold text-white">
                                        {githubStats.lastUpdate}
                                    </p>
